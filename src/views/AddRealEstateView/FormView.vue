<template>
   <div class="form-wrapper">
      <form class="add-form">
         <input id="price" v-model="store.addAnnouncemnt.price" type="number" name="price" placeholder="Cena" />
         <input id="numberOfPlot" type="text" name="numberOfPlot" placeholder="Numer Działki" />
         <textarea
            id="description"
         ...
         />
         <input id="email" v-model="store.addAnnouncemnt.email" type="text" name="email" placeholder="Adres email" />
         <div
            class="drop-zone"
         ...
         >
            ...
            <input id="photos" ref="fileInput" multiple type="file" name="photos" @change="handleFileChange" />
            <div class="image-previews">
               <div v-for="(image, index) in compressedImages" :key="index" class="image">
         ...
         <div class="sewage">
            ...
            <input id="sewage" type="checkbox" name="sewage" />
         </div>
         <div class="water">
         ...
         <div class="access-to-road">
            ...
            <input id="access-to-road" type="checkbox" name="access-to-road" />
         </div>
...
const validateForm = (e) => {
   e.preventDefault()
   if (store.addAnnouncemnt.price && store.addAnnouncemnt.description && store.addAnnouncemnt.email) {
